...
SGX_COMMON_CFLAGS +=-DREPORT_3P_STATS
SGX_COMMON_CFLAGS +=-DREPORT_APPEND_STATS
SGX_COMMON_CFLAGS +=-DREPORT_SORT_STATS
SGX_COMMON_CFLAGS +=-DREPORT_JOIN_WRITE_STATS
SGX_COMMON_CFLAGS +=-DREPORT_BIN_PACKING_JOIN_STATS

# Tests
#SGX_COMMON_CFLAGS +=-DTEST_SPINLOCK
#SGX_COMMON_CFLAGS +=-DTEST_PROJECTIONS
#SGX_COMMON_CFLAGS +=-DTEST_BARRIERS
#SGX_COMMON_CFLAGS +=-DOCALL_ECALL_TESTS
#SGX_COMMON_CFLAGS +=-DTEST_THREADS
#SGX_COMMON_CFLAGS +=-DTEST_COLUMN_SORT_16
#SGX_COMMON_CFLAGS +=-DTEST_BITONIC
#SGX_COMMON_CFLAGS +=-DTEST_BCACHE
#SGX_COMMON_CFLAGS +=-DPROMOTE_COLUMN
SGX_COMMON_CFLAGS +=-DTEST_RANKINGS
...
#SGX_COMMON_CFLAGS +=-DTEST_MERGE_SORT_WRITE
SGX_COMMON_CFLAGS +=-DTEST_BIN_PACKING_JOIN
SGX_COMMON_CFLAGS +=-DTEST_HASH_BIN_PACKING_JOIN
# SGX_COMMON_CFLAGS +=-DTEST_OBLIVIOUS
